...
public class Game
{
    ...
    public int Likes { get; set; } = new Random().Next(50, 5000);
    public int Dislikes { get; set; } = new Random().Next(8, 500);
    ...
    public HardcodedGame HardcodedGame { get; set; } = HardcodedGame.None;
}
